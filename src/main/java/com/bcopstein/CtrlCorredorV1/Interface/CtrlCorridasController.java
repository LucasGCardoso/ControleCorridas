package com.bcopstein.CtrlCorredorV1.Interface;
...
public class CtrlCorridasController {
    ...
    public EstatisticasDTO estatisticas(@RequestParam final int distancia){
        List<Evento> lista = estatisticasService.getPorDistancia(distancia);  
        double soma = 0;
        double mediana;
    ...
    public PerformanceDTO aumentoPerformance(@RequestParam final int distancia, @RequestParam final int ano){
        List<Evento> lista = estatisticasService.getPorDistanciaEAno(distancia, ano);
